...
public class TopicOverviewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("test", topic);
        View view = null;
        view = inflater.inflate(R.layout.fragment_topic_overview, container, false);
        mButton = (Button) view.findViewById(R.id.button4);
        title = (TextView) view.findViewById(R.id.textView7);
        title.setText(topic);
        title = (TextView) view.findViewById(R.id.textView9);
        int number = questions.size();
        title.setText("Number of Questions:" + number);
